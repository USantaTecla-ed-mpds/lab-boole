...
console.writeln(`El intervalo [${minInterval}, ${maxInterval}] intersección con el intervalo [${minInterval2}, ${maxInterval2}] será el intervalo [${intersectionMin}, ${intersectionMax}]`);